...
zebra2Map.applyMotionRecurse('Rachel')
...
RachelFace = scene.createFaceDefinition('Rachel')
...
# Set up Rachel
Rachel = scene.createCharacter('Rachel', '')
...
bml.execBML('Rachel', '<body posture="ChrMarine@Idle01"/>')
bml.execBML('Rachel', '<saccade mode="listen"/>')
