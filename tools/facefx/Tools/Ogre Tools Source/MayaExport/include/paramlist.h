...
namespace OgreMayaExporter
{
	...
	public:
		...
		bool exportMesh, exportMaterial, exportAnimCurves, exportCameras, exportAll, exportVBA,
			...
			buildTangents, buildEdges, skelBB, bsBB, vertBB, exportScene,useBlendshapeDeformerName,
		...
		MString meshFilename, skeletonFilename, materialFilename, animFilename, camerasFilename, matPrefix,
			texOutputDir, particlesFilename, sceneFilename;
		...
		ParamList()	{
			...
			exportScene = false;
			sceneFilename = "";
			useBlendshapeDeformerName = false;
		}
		...
		ParamList& operator=(ParamList& source)	
		{
			...
			useBlendshapeDeformerName = source.useBlendshapeDeformerName;
