...
class WxConsoleView(stc.StyledTextCtrl):
    ...
    def __init__(self, parent, prompt, intro="", background_color="BLACK",
        ...
        # OC3 - jcr: changed from ctrl+b/n to ./, so as to not get in the
        #            way of Studio.
        ...
        # OC3 - jcr 768 is the minimum width of the FaceFX Studio main window.
        #           this prevents the horizontal scroll bar from being the
        #           default 2000 pixels.
        self.SetScrollWidth(768)
